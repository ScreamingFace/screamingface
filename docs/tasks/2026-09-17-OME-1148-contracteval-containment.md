...
**Rebuild.** The first implementation (PR #865) was closed unmerged; `main` then moved 191
commits under the onboarding-infra overhaul. Prior work preserved at tag
`OME-1148-v1-pre-overhaul`. Not importable from inspect_evals — `ContractBench` there is
software/API contracts, a name collision.
