...
Validation: full Engine gates green; 37 new cases, seven healthy built-in board runs compared full/off with unchanged results/requests; independent Standards and Spec reviews clear. Endpoint implementations now own emission; shared factories declare once, installers only register routes. URL4 is unchanged. PR remains draft, not merged.
