...
2026-09-23: imported aggregation now awaits the shared scorer on its owning loop, restoring case-grading Logs without worker-thread forwarding. Sync APIs remain available; native-route report parity, cancellation, selection and errors covered. Full Engine gates and 174 focused async/Inspect checks pass; existing installation test await migration owner-approved. Draft/In Progress retained.
