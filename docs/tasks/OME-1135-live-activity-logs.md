...
2026-09-22: compact logs size to content up to 280px with 8px padding; candidate names stay on one horizontally scrollable line. Verified in Jupyter without model calls. Remains draft/In Progress.
