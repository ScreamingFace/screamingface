...
- 2026-09-15: rename done in the working tree — naming test RED→GREEN; focused suite 164 passed; stack gates green with the append-only check skipped (that check flags the rename itself); OpenAPI byte-identical to `fb4c414e`. Commit awaiting authorisation; Linear In Progress.
