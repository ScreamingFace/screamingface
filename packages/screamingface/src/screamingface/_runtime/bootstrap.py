...
# The former justfile's gateway environment, now runtime defaults (OME-1001). Every
# entry is a setdefault: an explicit operator choice always wins.
LOCAL_GATEWAY_DEFAULTS = {
    ...
    # Re-activates stored provider profiles (e.g. the OpenRouter key) at boot —
    # without it a restarted gateway exposes no openrouter/* models.
