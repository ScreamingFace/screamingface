...
class TestTapeValidationOnRead:
    def test_a_valid_tape_round_trips_with_raw_response_bytes(self, tmp_path) -> None:
    ...
    def test_lookup_finds_an_exchange_by_its_normalized_identity(self, tmp_path) -> None:
        path = tmp_path / "tape.json"
        path.write_text(json.dumps(_tape_document()))
        tape = load_tape(path)
    ...
    def test_an_unknown_schema_is_refused_on_read(self, tmp_path) -> None:
    ...
    def test_a_malformed_fingerprint_is_refused_on_read(self, tmp_path) -> None:
    ...
    def test_duplicate_exchange_identities_are_refused_on_read(self, tmp_path) -> None:
    ...
    def test_the_authored_flag_must_be_stated_not_defaulted(self, tmp_path) -> None:
...
class TestGoldenCompareOrder:
    def test_a_changed_expression_fails_as_stale_goldens_never_as_scores(self, tmp_path) -> None:
    ...
    def test_matching_outcome_passes(self) -> None:
        golden = GoldenReport.model_validate(_golden_document())
        actual = ActualOutcome(
    ...
    def test_case_statuses_are_checked_before_the_score(self) -> None:
        golden = GoldenReport.model_validate(_golden_document())
        actual = ActualOutcome(
            rendered_url4="rendered expression",
    ...
    def test_a_coverage_figure_that_contradicts_the_statuses_is_caught(self) -> None:
    ...
    def test_a_score_drift_is_reported_as_decimal_strings(self) -> None:
        golden = GoldenReport.model_validate(_golden_document())
        actual = ActualOutcome(
            rendered_url4="rendered expression",
            final_score=0.75,
...
class TestGoldenValidationOnRead:
    def test_load_golden_reads_a_valid_document(self, tmp_path) -> None:
    ...
    def test_unknown_fields_are_refused(self, tmp_path) -> None:
    ...
    def test_counters_must_agree_with_the_statuses(self, tmp_path) -> None:
    ...
    def test_an_unknown_case_status_is_refused(self, tmp_path) -> None:
        path = tmp_path / "synthetic.golden.json"
        path.write_text(
...
class TestCanonicalScore:
    def test_floats_render_as_shortest_round_trip_decimal_strings(self) -> None:
    ...
    def test_the_rendered_string_round_trips_to_the_exact_float(self) -> None:
    ...
    def test_absent_scores_stay_absent(self) -> None:
